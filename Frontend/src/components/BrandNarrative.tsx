      ...
      <div className="mx-auto max-w-[1320px] px-5 sm:px-8 relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-x-16 gap-y-10 items-start border-b border-white/5 pb-12">
          ...
          >
            {/* Identity Anchor */}
            <div className="mb-8">
              <img src="/logo-new.png" alt="Soliva" className="h-10 md:h-12 w-auto object-contain brightness-[1.5] mb-6" />
            ...
            <h2 className="font-display text-white tracking-tight leading-[1.15] mb-8" style={{ fontSize: "clamp(2rem, 4vw, 3rem)" }}>
            ...
            <div className="space-y-10 max-w-[520px]">
              <div className="flex gap-4">
                ...
                <p className="text-[1.0625rem] md:text-[1.125rem] text-white/80 font-light leading-relaxed">
                  Soliva was born from a simple observation: Indian movement is constant exposure. We noticed that protection hadn’t evolved alongside the streets it was built for.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-8 border-t border-white/5 pt-8">
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono text-[0.5625rem] tracking-[0.2em] text-[#c76600]/60 uppercase font-bold">The Philosophy</span>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    <span className="text-[0.5rem] text-[#c76600]/60">○</span>
                    <span className="font-mono text-[0.5625rem] tracking-[0.2em] text-[#c76600]/60 uppercase font-bold">The Standard</span>
                  </div>
                  <p className="text-[0.8125rem] text-white/60 font-light leading-relaxed">
          ...
          >
            ...
            <div className="col-span-2 space-y-4">
              <span className="font-mono text-[0.5625rem] tracking-[0.4em] text-[#c76600] uppercase font-black opacity-60">Identity</span>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <span className="font-mono text-[0.5625rem] tracking-[0.4em] text-[#c76600] uppercase font-black opacity-60">Action</span>
                <a href="https://wa.me/917350640608" className="group flex flex-col w-fit">
                  <div className="flex items-center gap-3 text-white/80 group-hover:text-[#c76600] transition-colors duration-500 font-mono text-[0.75rem] tracking-[0.2em] font-black uppercase">
                    <MessageCircle size={14} className="text-[#25D366] opacity-70 group-hover:opacity-100" />
                    WhatsApp
                  </div>
              ...
              <div className="space-y-4">
                <span className="font-mono text-[0.5625rem] tracking-[0.4em] text-[#c76600] uppercase font-black opacity-60">Explore</span>
                <nav className="flex flex-col gap-3">
                  {["Home", "Collection", "Story", "Identity"].map((label) => (
                    <Link key={label} to={label === "Home" ? "/" : `/${label.toLowerCase()}`} className="group flex items-center gap-3 font-mono text-[0.6875rem] tracking-[0.15em] text-white/40 hover:text-white uppercase transition-all duration-500">
                      <ArrowRight size={10} className="opacity-0 -translate-x-2 group-hover:opacity-40 group-hover:translate-x-0 transition-all" />
                      {label}
                    </Link>
                  ))}
                </nav>
            ...
            <div className="space-y-6">
              <span className="font-mono text-[0.5625rem] tracking-[0.4em] text-[#c76600] uppercase font-black opacity-60">Presence</span>
              <div className="flex flex-col gap-4">
                {[
                  ...
                  <a key={s.name} href={s.url} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 font-mono text-[0.6875rem] tracking-[0.1em] text-white/40 hover:text-white transition-all duration-500">
                    <div className="w-4 h-4 opacity-40 group-hover:opacity-100 transition-all duration-500">
                      <div className="w-full h-full transition-colors duration-500 group-hover:text-[var(--hover-color)]" style={{ '--hover-color': s.color } as any}>
