...
export function CompareSection() {
  ...
  return (
    ...
    >
      ...
      {/* LUXURY EDITORIAL BACKGROUND — CSS keyframes instead of JS-driven Framer Motion */}
        ...
        >
          ...
          <div className="relative flex flex-col md:flex-row items-stretch gap-4 sm:gap-6 z-10">
            ...
            >
              ...
              {/* Interaction Glow — reduced size & blur */}
              <motion.div
                style={{
                  left: leftSpringX,
                  top: leftSpringY,
              ...
              <div className="relative z-10">
                ...
                <div className="mb-4 sm:mb-5 lg:mb-6 grid grid-cols-3 gap-3 sm:gap-4 lg:gap-6 rounded-xl border-y border-line-medium bg-[#F3ECE2]/40 px-3 sm:px-4 py-3 sm:py-4 lg:py-5 inset-shadow-line transition-colors duration-700 group-hover/old:bg-[#F3ECE2]/60">
            ...
            >
              ...
              {/* Mouse Tracking Interaction Glow — reduced size & blur */}
              <motion.div
                style={{
                  left: rightSpringX,
                  top: rightSpringY,
              ...
              <div className="absolute top-0 right-0 w-48 h-48 bg-accent-ghost blur-[40px] -mr-24 -mt-24 rounded-full" />
              ...
              <div className="relative z-10">
                ...
                <div className="mb-4 sm:mb-6 lg:mb-8 grid grid-cols-3 gap-3 sm:gap-4 lg:gap-6 rounded-2xl border-y border-line-accent bg-surface-glass-strong px-3 sm:px-5 lg:px-6 py-4 sm:py-5 lg:py-7 shadow-floating inset-shadow-line transition-colors duration-700 group-hover/card:bg-white">
                  <div className="space-y-1 sm:space-y-1.5">
                    ...
                    <span className="block font-mono font-black tracking-tighter text-brown-deep text-display-metric">ADV</span>
                  </div>
                  <div className="space-y-1 sm:space-y-1.5 border-x border-line-accent px-2 sm:px-4 md:px-6">
                    ...
                    <span className="block font-mono font-black tracking-tighter text-brown-deep text-display-metric">0×</span>
                  </div>
                  <div className="space-y-1 sm:space-y-1.5">
                    ...
                    <span className="block font-mono font-black tracking-tighter text-brown-deep text-display-metric">360°</span>
                  </div>
                </div>
      ...
      <div className="relative mt-5 sm:mt-6 border-y border-line-medium bg-surface-glass py-3 sm:py-4 lg:py-5 overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_12%,black_88%,transparent)]">
