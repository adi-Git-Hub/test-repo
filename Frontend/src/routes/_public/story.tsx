        ...
        <div className="mx-auto max-w-[1320px] px-5 sm:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-start">
            ...
            <div className="flex flex-col text-left pt-8">
              ...
              <h2 className="font-display text-[#3a2a22] tracking-tight leading-[1.1] mb-10" style={{ fontSize: "clamp(2rem, 5vw, 3.5rem)" }}>
              ...
              <div className="space-y-8 text-[1rem] sm:text-[1.125rem] text-[#7b6a5f] font-light leading-relaxed max-w-lg">
                <p>
                  Returning to central India after years in the UK was a sensory shock. Not just the heat, but the realization of how we move through it.
                </p>
                <p>
                  I was riding a scooter through the peak of May, draped in a thin cotton scarf that kept slipping, trapped heat, and left gaps of exposed skin that burned within minutes.
                </p>
                <div className="pl-6 border-l-2 border-[#c76600]/30 italic text-[#3a2a22] font-medium">
                  "I was solving a practical problem with a piece of cloth that was never designed to solve it."
                </div>
                <p>
                  It wasn't just me. Thousands of riders around me were performing this daily ritual of improvised protection—adjusting, tucking, and struggling.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-24 md:py-32 bg-luxury-beige/20 overflow-hidden">
        <div className="mx-auto max-w-[1440px] px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-stretch">
            ...
            >
              ...
              <div className="absolute bottom-10 left-10">
                <span className="font-mono text-[0.5rem] tracking-[0.2em] text-white/70 uppercase font-black px-4 py-2 bg-black/20 backdrop-blur-md rounded-full">Archive: Exposure 01</span>
              </div>
            </motion.div>
            ...
            <div className="lg:col-span-5 flex flex-col gap-6 lg:gap-8">
              ...
              >
                ...
                <p className="text-[1.125rem] md:text-[1.35rem] text-[#3a2a22] font-light leading-relaxed">
                  Daily commuting in India is a test of endurance. Between the dust, the exhaust, and the relentless sun, we've settled for <span className="text-[#c76600] font-medium italic">"good enough"</span> for too long.
                </p>
              </motion.div>
          ...
          <div className="mt-20 flex items-center justify-between px-10 opacity-20">
            <span className="font-mono text-[0.5rem] tracking-[0.5em] uppercase font-black">SS/26 Documentation</span>
            <div className="flex-1 h-px bg-[#3a2a22]/20 mx-12" />
            <span className="font-mono text-[0.5rem] tracking-[0.5em] uppercase font-black">Archive Series</span>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1320px] px-5 sm:px-8">
          <div className="flex flex-col lg:flex-row justify-between items-end mb-16 gap-8 text-left">
            ...
            <p className="text-[0.9375rem] text-[#7b6a5f] font-light max-w-sm">
              We identified three core groups whose daily movement was completely overlooked by existing brands.
            </p>
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <span className="font-mono text-[0.5rem] tracking-[0.2em] text-[#c76600] uppercase font-black mb-2">{card.tag}</span>
                  <h3 className="font-display text-2xl text-[#3a2a22] mb-4">{card.title}</h3>
                  <p className="text-[0.875rem] text-[#7b6a5f] font-light leading-relaxed">{card.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-[1320px] px-5 sm:px-8 relative z-10">
          <div className="text-center mb-20">
            <motion.h2 
              ...
              className="font-display text-white tracking-tight leading-[1.1]" style={{ fontSize: "clamp(2rem, 5vw, 3.5rem)" }}
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="grid grid-cols-1 gap-12">
              {[
                { title: "Hidden Exposure Zones", desc: "Most products leave gaps at the neck and wrists. We designed for zero-gap protection." },
                { title: "Heat Build-Up", desc: "Traditional fabrics trap heat against the skin. Our architecture creates an active air gap." },
                { title: "Dust & Pollution", desc: "Urban movement is more than just sun. It's about a breathable shield against the city." },
              ].map((item, i) => (
                <motion.div
                  key={i}
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[0.875rem] text-white/60 font-light leading-relaxed">{item.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
      ...
      <section className="relative py-[70px] sm:py-[90px] md:py-[120px]">
        <div className="mx-auto max-w-[1320px] px-5 sm:px-8 text-center">
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            {[
              { type: "Dupattas & Stoles", failure: "Trap heat, require constant manual adjustment, and don't provide calibrated UV blocking." },
              { type: "Sunscreen Alone", failure: "Wear off with sweat, difficult to reapply during commutes, and provides zero physical shielding." },
              { type: "Heavy Biker Gear", failure: "Overkill for city routines. Too hot, too bulky, and socially out of place at the office or cafe." },
            ].map((item, i) => (
              <div key={i} className="flex flex-col md:flex-row items-center gap-6 md:gap-16 border-b border-[#3a2a22]/5 pb-12 last:border-0">
      ...
      <section className="relative py-[70px] sm:py-[90px] md:py-[120px] bg-white/40">
        <div className="mx-auto max-w-[1320px] px-5 sm:px-8 text-center">
          <div className="max-w-4xl mx-auto mb-20">
            ...
            <h2 className="font-display text-[#3a2a22] tracking-tight leading-[1.1] mb-8" style={{ fontSize: "clamp(2.5rem, 6vw, 4.5rem)" }}>
        ...
        <div className="mx-auto max-w-[1320px] px-5 sm:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-6">
            {[
              ...
              >
                <span className="font-mono text-[0.5625rem] tracking-[0.2em] text-[#c76600] uppercase font-black">{step.time}</span>
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-[1000px] px-5 text-center">
          <motion.div
            ...
            transition={{ duration: 1.2, ease: "easeOut" }}
          >
            <h2 className="font-display text-[#3a2a22] leading-[1.1] mb-8" style={{ fontSize: "clamp(2.25rem, 6vw, 4.5rem)" }}>
